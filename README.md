...
This branch targets Odoo `18.0`. The installer is branch-aware, so Odoo 18 installations select this branch automatically when it is published.
...
./install-perfect-odoo-mcp.sh --branch 18.0 --database YOUR_DATABASE
```
