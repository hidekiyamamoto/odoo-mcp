...
class ResConfigSettings(models.TransientModel):
    ...
    odoo_mcp_mcp_url = fields.Char(
        string="MCP URL",
        default=lambda self: self._get_odoo_mcp_mcp_url(),
        readonly=True,
    )
    odoo_mcp_custom_tools_enabled = fields.Boolean(
    ...
    odoo_mcp_sql_enabled = fields.Boolean(
    ...
    odoo_mcp_sql_readonly = fields.Boolean(
        string="SQL Readonly",
    ...
    def get_values(self):
        ...
        values["odoo_mcp_mcp_url"] = self._get_odoo_mcp_mcp_url()
        return values
